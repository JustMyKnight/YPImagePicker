...
public extension UIView {
    ...
    /**
     ...
     For instance
        ...
        addConstraint(item: view1, attribute: .SteviaCenterX, toItem: view2)
     
     is equivalent to
     
         addConstraint(
            NSLayoutConstraint(item: view1,
                attribute: .SteviaCenterX,
                 relatedBy: .Equal,
                 toItem: view2,
                 attribute: .SteviaCenterX,
                 multiplier: 1,
...
/**
 ...
 For instance 
        ...
        constraint(item: view1, attribute: .SteviaCenterX, toItem: view2)
 
  is equivalent to
 
        NSLayoutConstraint(item: view1, attribute: .SteviaCenterX,
        relatedBy: .Equal,
        toItem: view2, attribute: .SteviaCenterX,
